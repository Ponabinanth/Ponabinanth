    ...
    <section id="about" className="py-20 border-t border-white/5 relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-xs mt-2 uppercase tracking-widest">Bridging Java Rigor with Intelligent LLMs</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="glass-panel p-6 rounded-2xl border-cyan-500/10">
              <h3 className="text-lg font-bold font-display text-white mb-3">Professional Narrative</h3>
              <p className="text-sm text-gray-300 leading-relaxed font-sans">
                {portfolioData.about}
              </p>
              <div className="flex flex-wrap gap-4 mt-4 text-xs font-mono text-gray-400 border-t border-white/5 pt-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold font-display text-white">Core Strengths</h3>
              <div className="grid grid-cols-1 gap-3">
                {strengths.map((str, i) => (
                  <div key={i} className="glass-panel-light p-4 rounded-xl border border-white/5 flex gap-3 items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-white font-display">{str.title}</h4>
                      <p className="text-xs text-gray-400 mt-1 leading-normal">{str.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {portfolioData.timeline.map((item, idx) => (
                <div key={idx} className="relative">
                  ...
                  <div className="glass-panel-light p-4 rounded-2xl border border-white/5 hover:border-cyan-500/10 transition-all">
                    ...
                    <p className="text-xs text-gray-400 mt-1 leading-normal">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12 border-t border-white/5 pt-10">
          <div className="glass-panel-light p-5 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-white font-display">Passions & Interests</h4>
          ...
          <div className="glass-panel-light p-5 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-white font-display">Personal Philosophy</h4>
              <p className="text-xs text-gray-400 mt-1 leading-relaxed">
